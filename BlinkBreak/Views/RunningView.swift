...
struct RunningView<Controller: SessionControllerProtocol>: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            // ⚡ Bolt Optimization: Scope TimelineView tightly around the ticking component
            // to prevent the entire view hierarchy and static buttons from re-rendering every second.
