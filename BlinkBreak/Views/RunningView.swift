...
struct RunningView<Controller: SessionControllerProtocol>: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            // ⚡ Bolt: Scoped TimelineView exclusively around the CountdownRing.
            // This prevents the surrounding static layout (buttons, text, toggles)
            // and expensive string formatting from re-rendering every second.
